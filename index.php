        ...
        <div class="col-lg-12">
            ...
            <div class="card-deck mb-4">
                <div class="card text-white bg-dark">
                    ...
                    <div class="card-footer text-muted">
                        <small><strong>Latest release:</strong> v1.07.1<br/>
                            <strong>Release date:</strong> 31st October 2018
                        </small>
                    </div>
                </div>
                ...
                <div class="card text-white bg-dark">
                    ...
                    <div class="card-footer text-muted">
                        <small><strong>Latest release:</strong> v1.02.3<br/>
                            <strong>Release date:</strong> 18th October 2018
                        </small>
                    </div>
                </div>
            ...
            <div class="card-deck mb-4">
                <div class="card text-white bg-dark">
                    ...
                    <div class="card-footer text-muted">
                        <small><strong>Latest release:</strong> v3.15.0<br/>
                            <strong>Release date:</strong> 25th October 2018
                        </small>
                    </div>
                </div>
