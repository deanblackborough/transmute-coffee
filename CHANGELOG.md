...
## v1.107.0 - New releases - 2023-01-30
* Updated release dates and versions.

## v1.106.0 - New releases - 2022-10-31
* Updated release dates and versions.
...
* New release, Costs to Expect API, v2.21.0
* New release, PHP Quill renderer, v4.00.2
...
* New release, Costs to Expect Website, v1.13.1

## v1.99.0 - New releases - 2020-11-22
* New release, Costs to Expect App, v1.20.0
* New release, Costs to Expect API, v2.17.0
* New release, Costs to Expect Website, v1.13.1

## v1.98.0 - New releases - 2020-09-29
* New release, Costs to Expect App, v1.18.1
* New release, Costs to Expect API, v2.14.0
* New release, Costs to Expect Website, v1.13.0

## v1.97.0 - New releases - 2020-09-17
* New release, Costs to Expect App, v1.17.2
* New release, Costs to Expect API, v2.13.1

## v1.96.0 - New releases - 2020-09-15
* New release, Costs to Expect App, v1.17.1
* New release, Costs to Expect API, v2.13.0
* New release, Costs to Expect Website, v1.12.6

## v1.95.0 - New releases - 2020-06-06
* New release, Costs to Expect App, v1.15.1
* New release, Costs to Expect API, v2.11.0
* New release, Costs to Expect Website, v1.12.5

## v1.94.0 - New releases - 2020-05-24
* New release, Costs to Expect App, v1.15.0
* New release, Costs to Expect API, v2.10.4
* New release, Costs to Expect Website, v1.12.4

## v1.93.0 - New releases - 2020-05-12
* New release, Costs to Expect API, v2.10.3
* New release, Costs to Expect App, v1.14.1

## v1.92.0 - New releases - 2020-04-12
* New release, Costs to Expect Website, v1.12.3
* New release, Costs to Expect App, v1.10.1
* New release, Costs to Expect API, v2.10.1

## v1.91.0 - New releases - 2020-03-29
* New release, Costs to Expect API, v2.09.4
* New release, Costs to Expect App, v1.08.1

## v1.90.0 - New release - 2020-03-19
* New release, Costs to Expect Website v1.12.2
* New release, Costs to Expect App, v1.05.0
* New release, Costs to Expect API, v2.09.1
* Updated FE dependencies.
* Updated BE dependencies.

## v1.89.0 - New releases - 2020-02-26

* New release, Costs to Expect Website, v1.12.1.
* New release, Costs to Expect API, v2.08.0.
* New release, Costs tp Expect App, v1.03.1.

## v1.88.0 - New release - 2020-02-17

* New release, Costs to Expect Website, v1.12.0.
...
* New release, Costs to Expect Website, v1.11.0.
* New release, Costs to Expect API, v2.07.0.

## v1.85.0 - New release - 2020-01-31

* New release, Costs to Expect App, v1.00.0.

## v1.84.0 - New release - 2020-01-19

* New release, Costs to Expect API, v2.06.0.

## v1.83.0 - New release - 2020-01-17

* New release, Costs to Expect Website, v1.10.9.
* Minor content updates.

## v1.82.0 - New releases - 2019-12-29

* New release, Costs to Expect API, v2.05.0.
* New release, Costs to Expect Website, v1.10.8.

## v1.81.0 - New releases - 2019-12-12

* New release, Costs to Expect API, v2.04.1.
* New release, Costs to Expect Website, v1.10.7.
* New project, Costs to Expect App, in dev.
* Updated dependencies.

## v1.80.0 - New release - 2019-11-12

* New release, Costs to Expect API, v2.04.0.
* New release, Costs to Expect Website, v1.10.6.

## v1.79.0 - New releases - 2019-10-07

* New release, Costs to Expect API, v2.02.0.
* New release, Costs to Expect Website, v1.10.5.

## v1.78.0 - New releases - 2019-09-18

* New release, Costs to Expect API, v2.01.2.
* New release, Costs to Expect Website, v1.10.4.
* New release, Costs to Expect Web app, v1.04.8.

## v1.77.0 - New releases - 2019-09-05

* New release, Costs to Expect API, v1.23.0.
* Updated FE dependencies.

## v1.76.0 - New releases - 2019-09-18

* New release, Costs to Expect API, v2.00.0.
* New release, Costs to Expect Website, v1.10.2.
* New release, Costs to Expect Web app, v1.04.6.

## v1.75.0 - New releases - 2019-08-31

* New release, Costs to Expect API, v1.22.1.
* New release, Costs to Expect Website, v1.10.1.

## v1.74.0 - New releases - 2019-08-28

* New release, Costs to Expect API, v1.22.0.
* New release, Costs to Expect Website, v1.10.0.
...
* New release, Costs to Expect Web app, v1.04.4.

## v1.67.0 - New release - 2019-07-06

* New release, Costs to Expect Website, v1.06.1.

## v1.66.0 - New releases - 2019-06-30

* New release, Costs to Expect API, v1.16.0.
