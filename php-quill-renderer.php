...
<div class="container">
            ...
            <div class="jumbotron text-light">
                ...
                <p class="text-right">
                    <a href="https://github.com/deanblackborough/php-quill-renderer"
                       class="btn btn-primary">View on GitHub - v3.14.0</a>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <p class="lead">Quill deltas renderer, converts deltas to HTML and Markdown, the Quill attributes supported
                are listed in the table in the README, the goal is to eventually support every Quill feature and
                add additional parsers.</p>
...
echo $result;</pre>
            ...
            <h2 id="demo">Demo <small>v3.14.0</small></h2>
